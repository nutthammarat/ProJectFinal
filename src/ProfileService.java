...
public class ProfileService {
    ...
    public static void getDetailUser(String user) {
        ProfileForm.lbl_username.setText(UserDao.getUser(user).getUsername());
        ProfileForm.lbl_address.setText(UserDao.getUser(user).getAddress());
        ProfileForm.lbl_phone.setText(UserDao.getUser(user).getPhone());
    }
